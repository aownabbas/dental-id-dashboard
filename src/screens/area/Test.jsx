...
const Test = () => {
      ...
      reader.onload = function (f) {
        ...
        fabric.Image.fromURL(
          ...
          function (img) {
            ...
            // adjustObjectsToImageSize(canvas, img);
          },
  ...
  const exportToJson = async () => {
    ...
    saveAs(blob, imageBase64StringObj?.fileName + ".json");
  };
